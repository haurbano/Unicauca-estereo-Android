 ...
 */
public class Domingo extends TitleFragment {

    public final static String dia = "Sunday";

    View v;
    ListView list_domingo;
    private final String title = "Domingo";
    public Domingo() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_domingo, container, false);
        list_domingo = (ListView) v.findViewById(R.id.list_domingo);
        cargarProgramas();
        return v;
    }
    ...
    public void cargarProgramas()
    {
        ...
        if(programas != null)
        {
            ...
            list_domingo.setAdapter(adapter);
